...
// void sspmt_correct_test(const oc::CLP& cmd)
// {
...
//     sspmtSender.setTimer(timer);
//     sspmtReceiver.setTimer(timer);
...
//     sspmtSender.init(n, n, logp, numSlots);
//     sspmtReceiver.init(n, n, logp, numSlots);
    
//     vector<Plaintext> ptxts_diag;
//     vector<Plaintext> ptxts_sdiag;
//     vector<uint32_t> bin_sizes;
//     vector<uint32_t> ot_idx;
//     sspmtSender.preprocess(Y, ptxts_diag, ptxts_sdiag, bin_sizes, ot_idx);
    
//     vector<Ciphertext> encoded_in_he;
//     vector<Ciphertext> encoded_in_he_shift;
//     sspmtReceiver.encode_and_encrypt_noserialize(X, encoded_in_he, encoded_in_he_shift);
    
//     vector<Ciphertext> decoded_in_he;
//     sspmtSender.encrypted_decode(encoded_in_he, encoded_in_he_shift,
//         ptxts_diag, ptxts_sdiag, decoded_in_he);
    
//     oc::BitVector results;
//     sspmtReceiver.decrypt(decoded_in_he, bin_sizes, results);
